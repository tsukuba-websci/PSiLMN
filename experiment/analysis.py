...
def created_figs(file_path: str) -> None:
    ...
    network_type = file_path.split('/')[3]
    num_agents = file_path.split('/')[4].split('.')[0]
    ...
    for question in questions:
        ...
        for round_ in rounds:
            ...
            image_path = f'output/unbiased/figs/{network_type}/{num_agents}_q{question}_r{round_num}.png'
        ...
        gif_path = f'output/unbiased/figs/{network_type}/{num_agents}_q{question}.gif'
...
if __name__ == "__main__":
    ...
    output_analyse_path = Path("output/unbiased/analysis/")
